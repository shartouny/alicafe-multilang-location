                            ...
                            @foreach($fieldOptions as $data)
                                ...
                                <div class="row row-dd">
                                    ...
                                    <div class="col-xs-2">
                                        ...
                                        <input type="checkbox"
                                               id="field_showintable_{{ $data['field'] }}"
                                               name="field_showintable_{{ $data['field'] }}" @if(isset($dataRow->showintable) && $dataRow->showintable) checked="checked" @elseif($data['key'] == 'PRI')@elseif($data['type'] == 'timestamp' && $data['field'] == 'updated_at')@elseif(!isset($dataRow->showintable)) checked="checked" @endif>
                                                <label for="field_showintable_{{ $data['field'] }}">{{ __('voyager::generic.showintable') }}</label><br/>
